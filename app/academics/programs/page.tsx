...
import { BookOpen, Users, Award, Target, Calendar, Clock, Star, Trophy } from "lucide-react"
...
const academicPrograms = [
  {
    ...
    subjects: ["Play-based Learning", "Basic Literacy", "Numeracy", "Art & Craft", "Music & Movement", "Social Skills"],
    color: "blue",
    capacity: 30,
    enrolled: 28,
    fees: "NPR 15,000/month",
    features: ["Small Class Size", "Qualified Teachers", "Safe Environment", "Parent Engagement"],
  },
  {
    ...
    features: ["Interactive Learning", "Digital Resources", "Regular Assessment", "Extracurricular Activities"],
  },
  {
    ...
    features: ["Advanced Curriculum", "Laboratory Work", "Project-Based Learning", "Career Guidance"],
  },
  {
    ...
    features: ["SEE Preparation", "Mock Exams", "Individual Attention", "College Counseling"],
  },
]
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-blue-100 leading-relaxed">
              ...
              character development from early childhood through Grade 10.
            </p>
          </div>
        </div>
                  ...
                  <CardContent className="p-8">
                    ...
                    <div className="grid grid-cols-3 gap-4 mb-6">
                      <div className="text-center bg-gray-50 rounded-lg p-3 shadow-sm">
                        <div className="text-lg font-bold text-gray-900">{program.enrolled}</div>
                        <div className="text-xs text-gray-600">Enrolled</div>
                      </div>
                      <div className="text-center bg-gray-50 rounded-lg p-3 shadow-sm">
                        <div className="text-lg font-bold text-gray-900">{program.capacity}</div>
                        <div className="text-xs text-gray-600">Capacity</div>
                      </div>
                      <div className="text-center bg-gray-50 rounded-lg p-3 shadow-sm">
                        <div className="text-lg font-bold text-green-600">{program.fees}</div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
              ...
              <CardContent className="p-8">
                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-center py-3 px-4 bg-gray-50 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300">
                    <span className="text-gray-600 font-medium">Session Starts</span>
                    <span className="font-semibold text-blue-600">Baisakh 1, 2081</span>
                  </div>
                  <div className="flex justify-between items-center py-3 px-4 bg-gray-50 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300">
                    <span className="text-gray-600 font-medium">First Terminal Exam</span>
                    <span className="font-semibold text-green-600">Ashar 15-30, 2081</span>
                  </div>
                  <div className="flex justify-between items-center py-3 px-4 bg-gray-50 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300">
                    <span className="text-gray-600 font-medium">Second Terminal Exam</span>
                    <span className="font-semibold text-purple-600">Kartik 15-30, 2081</span>
                  </div>
                  <div className="flex justify-between items-center py-3 px-4 bg-gray-50 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300">
                    <span className="text-gray-600 font-medium">Final Exam</span>
                    <span className="font-semibold text-orange-600">Falgun 1-15, 2081</span>
                  </div>
                  <div className="flex justify-between items-center py-3 px-4 bg-gray-50 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300">
                    <span className="text-gray-600 font-medium">Session Ends</span>
                    <span className="font-semibold text-red-600">Chaitra 30, 2081</span>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-xl hover:shadow-2xl transition-shadow duration-300">
              <CardContent className="p-8">
                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-center py-3 px-4 bg-gray-50 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300">
                    <span className="text-gray-600 font-medium">School Starts</span>
                    <span className="font-semibold text-blue-600">9:00 AM</span>
                  </div>
                  <div className="flex justify-between items-center py-3 px-4 bg-gray-50 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300">
                    <span className="text-gray-600 font-medium">Morning Assembly</span>
                    <span className="font-semibold text-green-600">9:00 - 9:15 AM</span>
                  </div>
                  <div className="flex justify-between items-center py-3 px-4 bg-gray-50 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300">
                    <span className="text-gray-600 font-medium">Classes</span>
                    <span className="font-semibold text-purple-600">9:15 AM - 3:30 PM</span>
                  </div>
                  <div className="flex justify-between items-center py-3 px-4 bg-gray-50 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300">
                    <span className="text-gray-600 font-medium">Lunch Break</span>
                    <span className="font-semibold text-orange-600">12:00 - 1:00 PM</span>
                  </div>
                  <div className="flex justify-between items-center py-3 px-4 bg-gray-50 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300">
                    <span className="text-gray-600 font-medium">School Ends</span>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <Link href="/academics/facilities">
              ...
              >
                ...
                <h3 className="text-lg font-bold text-gray-900 mb-2">Academic Facilities</h3>
                <p className="text-gray-600 text-sm">Explore our modern learning facilities</p>
              </motion.div>
            </Link>
            ...
            <Link href="/contact">
              ...
              >
                ...
                <h3 className="text-lg font-bold text-gray-900 mb-2">Admissions</h3>
                <p className="text-gray-600 text-sm">Apply for admission to our programs</p>
              </motion.div>
            </Link>
          </div>
        </div>
