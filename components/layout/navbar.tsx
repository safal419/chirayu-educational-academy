          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            {navigationConfig.map((item) => (
              <div key={item.title} className="relative group">
                ...
                {/* Dropdown Menu */}
                <div className="absolute top-full left-0 w-56 bg-white rounded-lg shadow-lg border border-gray-200 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 transform translate-y-2 group-hover:translate-y-0">
                  <div className="py-2">
